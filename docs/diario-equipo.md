...
- **Castrillón Mora, Pablo**
- **Hu, Jianwu**
- **Olivencia Moreno, Pablo**
- **Ramírez Gil, Adrián**
- **Rodríguez Calderón, Antonio**
- **Varo Vera, Juan**
...
El equipo acuerda el siguiente reparto aproximado del grado de implicación, usando la escala **1–10** definida en el enunciado:

| Miembro | Grado de implicación | Porcentaje equivalente |
|--------|----------------------|------------------------|
| Pablo Castrillón Mora | 9 | 90% |
| Jianwu Hu | 9 | 90% |
| Pablo Olivencia Moreno | 9,5 | 95% |
| Adrián Ramírez Gil | 9 | 90% |
...
## Actas de acuerdos de reuniones

Solo se incluyen reuniones en las que se tomaron **decisiones relevantes para el desarrollo del proyecto**.
...
- **Acuerdo 2025-01-01:** Constitución formal del equipo de trabajo.
- **Acuerdo 2025-01-02:** Elección del nombre del proyecto: **Track-hub-1**.
...
- **Acuerdo 2025-04-01:** Revisión global del estado del proyecto.
